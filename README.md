...
The `backend/` directory contains a standalone Python + FastAPI audio-to-text
API (faster-whisper + OpenAI), independent of the Vite app. See
[`backend/README.md`](backend/README.md) for setup and usage.
